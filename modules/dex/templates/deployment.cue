		...
		template: {
			...
			spec: corev1.#PodSpec & {
				...
				containers: [
					{
						...
						// The listen addresses are set in the configuration
						// file, flags in extraArgs override them.
						args: [
							"dex",
							"serve",
						...
						if _config.envFrom != _|_ {
							envFrom: _config.envFrom
						}
						ports: [
							{
								name:          "http"
				...
				volumes: [
					{
						name: "config"
						secret: secretName: _config._configSecretName
					},
					{
						name: "tmp"
						_config.tmpVolume
