...
//timoni:generate timoni mod vendor crd -f https://github.com/cert-manager/cert-manager/releases/download/v1.21.1/cert-manager.crds.yaml
...
#IssuerSpec: {
		...
		solvers?: [...{
			...
			dns01?: {
				...
				rfc2136?: {
					...
					// Protocol to use for dynamic DNS update queries. Valid values are
					// (case-sensitive) ``TCP`` and ``UDP``; ``UDP`` (default).
					protocol?: "TCP" | "UDP"
				...
				route53?: {
					...
					// If set, the provider will manage only this zone in Route53 and will not do a
					...
					// or the inferred credentials from environment variables, shared credentials
				...
				gatewayHTTPRoute?: {
					...
					podTemplate?: {
						...
						spec?: {
							...
							// Kubernetes will reject pod creation if limits are lower than requests,
							// causing challenge failures.
							resources?: {
	...
	// Venafi configures this issuer to sign certificates using a CyberArk
	...
	venafi?: {
		...
		tpp?: {
			// Base64-encoded bundle of PEM CAs which will be used to validate the certificate
			// chain presented by the CyberArk Certificate Manager Self-Hosted server. Only
			// used if using HTTPS; ignored for HTTP.
			// If undefined, the certificate bundle in the cert-manager controller container
			// is used to validate the chain.
			caBundle?: string

			// Reference to a Secret containing a base64-encoded bundle of PEM CAs
			// which will be used to validate the certificate chain presented by the
			// CyberArk Certificate Manager Self-Hosted server.
			...
			// URL is the base URL for the vedsdk endpoint of the CyberArk Certificate
