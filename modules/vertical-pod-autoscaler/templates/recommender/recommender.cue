...
// The recommender objects are named `<instance>-recommender` and
// labeled with the component label.
_component: "recommender"

// Metadata of the recommender namespaced objects.
...
// Metadata of the recommender cluster-scoped objects (and the RBAC
...
// Label selector of the recommender pods.
#SelectorLabels: {
	#config:                       config.#Config
	[string]:                      string
...
// The port of the recommender metrics listener.
#MetricsPort: 8942
