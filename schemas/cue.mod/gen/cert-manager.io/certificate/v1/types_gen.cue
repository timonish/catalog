...
#CertificateSpec: {
	...
	keystores?: {
		...
		pkcs12?: {
			...
			// (e.g., because of company policy). Please note that the security of the
			// algorithm is not that important
	...
	// restrict the support to string like otherNames, cf RFC 5280 p 37
	// Any UTF8 String valued otherName can be passed with by setting the keys oid:
	// x.x.x.x and UTF8Value: somevalue for `otherName`.
	// Most commonly this would be UPN set with oid: 1.3.6.1.4.1.311.20.2.3
	// You should ensure that any OID passed is valid for the UTF8String type as we
	// do not explicitly validate this.
	otherNames?: [...{
	...
	renewal?: {
		...
		windows?: [...{
			// `cron` is a cron compliant string to allow when the renewal should be
			// allowed. Format is as shown below:
			// * * * * *
			// | | | | |
